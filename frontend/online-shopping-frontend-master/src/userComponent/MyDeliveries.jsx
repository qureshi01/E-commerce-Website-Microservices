...
const MyDeliveries = () => {
  ...
  let deliveryToken = sessionStorage.getItem("delivery-jwtToken");
  ...
  const retrieveMyOrder = async () => {
    const response = await axios.get(
      "http://localhost:8080/api/order/delivery/myorder?deliveryPersonId=" +
        delivery.id,
      {
        headers: {
          Authorization: "Bearer " + deliveryToken, // Replace with your actual JWT token
        },
      }
    );
